...
lib.NumericalIntegralRoutines=ctypes.c_int.in_dll(lib,'NumericalIntegralRoutines')
lib.RLimValConv=ctypes.c_int.in_dll(lib,'RLimValConv')
lib.RLimInnerVal=ctypes.c_int.in_dll(lib,'RLimInnerVal')
lib.choose_integral_routines.restype=None
lib.choose_integral_routines.argtypes=[ctypes.c_int, ctypes.c_int, ctypes.c_int]
