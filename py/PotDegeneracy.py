#potential degeneracy for mean phase mock
from dynio import *
from myutils import *
import h5py,os,sys
from scipy.stats import chi2
from plot import plot_pot
plt.ion()
...
plot_pot([0.6013295 ,  2.22171445], 'r-')
plot_pot([1,1], 'k-')
plot_pot([2.16523294471, 0.476724073476], 'g-')
...
plot_pot(10**np.array([-0.0306, -0.0714]), 'k:')
plot_pot(10**np.array([-0.2755, 0.3142]), 'r:')
plot_pot(10**np.array([0.2959, -0.3859]), 'g:')
#plt.xlim([10,100])
#plt.ylim([4,100])
#r=NFWHalo().Rs0.value
