...
outfile=lib.rootdir+'/plots/paper/'+halo+'allFitsR'+os.environ['DynRMAX']+'nP%d_MeanDist'%npart
...
x=np.logspace(-0.3,+0.3,20)
y=np.logspace(-0.3,+0.3,20)
...
dset=grp.create_dataset('sig_like', data=P2Sig(chi2.sf(cont1[2],1)))
