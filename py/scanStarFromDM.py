...
outdir=lib.rootdir+'/plots/paper/extra/Star/FromDM/Weight%d/'%useweight
if cleansample==0:
  outdir+='Full/'
elif cleansample==1:
  outdir+='Clean/'
...
FullSample=Tracer(halo,DynRMIN=rmin,DynRMAX=rmax,DynDataFile=''+halo+'starCleanFromDM.hdf5')
